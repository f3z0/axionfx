...
dat.utils.common = (function () {
  ...
  return { 
    ...
    isPosition: function(obj) {
      return  obj instanceof Array && obj.length > 0 && typeof obj[0]['x'] === 'number' &&  typeof obj[0]['y'] === 'number'
    },
...
dat.controllers.factory = (function (OptionController, NumberControllerBox, NumberControllerSlider, PositionListController, StringController, FunctionController, BooleanController, common) {
      ...
      return function(object, property) {
        ...
        console.log('o ' + JSON.stringify(initialValue))
          ...
          var w = window,
              ...
              function onChange() {
                ...
                changeTO = setTimeout(function(){
                  ...
                  r[parseInt(RegExp(/\[(\d)\]/g).exec(ele.id)[1])][RegExp(/\]\.(x|y)/g).exec(ele.id)[1]] = parseFloat(ele.value);
                  _this.setValue(r);
                }, 500); 
              }
