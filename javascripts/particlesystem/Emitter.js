...
function(Particle, TextureLoader, predefinedSystems, util) {
	...
	Emitter.prototype = {
		...
		reconfigure: function(config) {
			...
			this.splineAnchorPts.length = 0;

			this.splineIsPath = false;
			this.splineClockwise = true;
			this.splineSpeed = 1.0;
			this.splineRelForceOn = true;
		...
		_initParticle: function(particle) {
			...
			particle.renderMode = this.renderMode;
